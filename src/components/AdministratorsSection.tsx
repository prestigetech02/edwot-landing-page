        ...
        <div className="grid gap-10 lg:gap-14 items-center lg:grid-cols-2">
          <Reveal variant="scaleIn" className="order-1">
            <div className="mx-auto w-full max-w-xl lg:max-w-none">
              <img
                src="/hero-image.png"
                alt="Edwot dashboard for school administrators"
          ...
          <div className="order-2 text-center lg:text-left space-y-6">
            <Reveal variant="fadeUpSubtle">
              <div className="inline-flex items-center gap-2 bg-[#1800AD]/10 border border-[#1800AD]/20 rounded-full px-3.5 py-1 text-sm mx-auto lg:mx-0">
                ...
                <span className="text-xs font-medium text-[#1800AD]">Built for administrators</span>
              </div>
            </Reveal>

            <Reveal variant="fadeUp" delay={0.08}>
              <h2 className="text-3xl sm:text-4xl lg:text-[42px] font-black text-gray-900 leading-tight">
                Everything school administrators need in{' '}
                <span className="text-[#1800AD]">one place</span>
              </h2>
            </Reveal>

            <Reveal variant="fadeUp" delay={0.14}>
              <p className="text-gray-600 text-base sm:text-lg leading-relaxed max-w-xl mx-auto lg:mx-0">
                From admissions and attendance to fees, reports, and parent communication — Edwot gives
                administrators a clear, centralized workspace so daily operations run smoothly without
