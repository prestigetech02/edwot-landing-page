/** Decorative mesh layers for the blog hero (navy base applied on the section). */
export default function BlogHeroMesh() {
  return (
    <div className="pointer-events-none absolute inset-0 overflow-hidden" aria-hidden>
      ...
      >
        <defs>
          <pattern id="blog-mesh-diag" width="80" height="80" patternUnits="userSpaceOnUse" patternTransform="rotate(35)">
            <path d="M 0 40 L 80 40" stroke="white" strokeWidth="0.5" />
            <path d="M 40 0 L 40 80" stroke="white" strokeWidth="0.5" />
          </pattern>
        </defs>
        <rect width="100%" height="100%" fill="url(#blog-mesh-diag)" />
